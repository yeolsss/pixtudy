...
import { StLayoutContainer, StLayoutGuide, StNoActiveLayoutDiv, StPreviewContainer, StVideosLayoutContainer } from './styles/shareScreenContainer.styles'
...
export default function ShareScreenContainer() {
  ...
  // 가이드 상태
  const [currentGuide, setCurrentGuide] = useState<GuideStatusType | null>(null)
