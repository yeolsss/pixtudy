...
const GlobalStyle = styled.createGlobalStyle`
  ...
  * {
  ...
  :root {
    ...
    --color-text-interactive-primary: var(--color-brand-400);
    --color-text-interactive-primary-hovered: var(--color-brand-300);
    --color-text-interactive-primary-pressed: var(--color-brand-200);
    --color-text-interactive-secondary: var(--color-neutral-300);
    --color-text-interactive-secondary-hovered: var(--color-neutral-200);
    --color-text-interactive-secondary-pressed: var(--color-neutral-100);
    --color-text-interactive-selected: var(--color-brand-400);
    --color-text-interactive-visited: var(--color-indigo-500);
    --color-text-interactive-inverse: var(--color-neutral-900);
    --color-text-info-bold: var(--color-info-300);
    --color-text-info: var(--color-info-500);
    --color-text-warning-bold: var(--color-warning-200);
    --color-text-warning: var(--color-warning-400);
    --color-text-success-bold: var(--color-success-200);
    --color-text-success: var(--color-success-600);
    --color-text-danger-bold: var(--color-danger-200);
    ...
    --color-bg-info-bold: var(--color-info-400);
    --color-bg-interactive-primary: var(--color-brand-400);
    --color-bg-interactive-primary-hovered: var(--color-brand-300);
    --color-bg-interactive-primary-pressed: var(--color-brand-200);
    --color-bg-interactive-secondary: var(--color-neutral-900);
    --color-bg-interactive-secondary-hovered: var(--color-neutral-800);
    --color-bg-interactive-scondary-pressed: var(--color-neutral-700);
    --color-bg-interactive-danger: var(--color-danger-500);
    --color-bg-interactive-danger-hovered: var(--color-danger-400);
    --color-bg-interactive-danger-pressed: var(--color-danger-300);
    --color-bg-interactive-selected: var(--color-brand-900);
    --color-bg-interactive-selected-hovered: var(--color-brand-800);
    --color-bg-interactive-selected-press: var(--color-brand-700);
    --color-bg-info-subtle: var(--color-info-800);
    --color-bg-warning-bold: var(--color-warning-700);
    --color-bg-warning-subtle: var(--color-warning-800);
    --color-bg-success-bold: var(--color-success-300);
    --color-bg-success-subtle: var(--color-success-800);
    --color-bg-danger-bold: var(--color-danger-400);
    --color-bg-danger-subtle: var(--color-danger-800);
    --color-bg-inverse-bold: var(--color-neutral-100);
    --color-bg-inverse-bolder: var(--color-neutral-50);
    --color-bg-disabled: var(--color-neutral-300);
    --color-icon-primary: var(--color-neutral-50);
    --color-icon-brand: var(--color-brand-400);
    --color-icon-interactive-primary: var(--color-brand-400);
    --color-icon-interactive-primary-hovered: var(--color-brand-300);
    --color-icon-interactive-primary-pressed: var(--color-brand-200);
    --color-icon-interactive-secondary: var(--color-neutral-300);
    --color-icon-interactive-secondary-hovered: var(--color-neutral-200);
    --color-icon-interactive-secondary-press: var(--color-neutral-100);
    --color-icon-interactive-visited: var(--color-indigo-500);
    --color-icon-interactive-inverse: var(--color-neutral-900);
    --color-icon-info: var(--color-info-400);
    --color-icon-warning: var(--color-warning-400);
    --color-icon-success: var(--color-success-400);
    --color-icon-danger: var(--color-danger-400);
    ...
    --color-border-interactive-primary: var(--color-brand-400);
    --color-border-interactive-primary-hovered: var(--color-brand-300);
    --color-border-interactive-primary-pressed: var(--color-brand-200);
    --color-border-focusRing: var(--color-brand-400);
    --color-border-info: var(--color-info-400);
    --color-border-info-subtle: var(--color-info-700);
    --color-border-warning: var(--color-warning-400);
    --color-border-warning-subtle: var(--color-warning-700);
    --color-border-success: var(--color-success-400);
    --color-border-success-subtle: var(--color-success-700);
    --color-border-danger: var(--color-danger-400);
    --color-border-danger-subtle: var(--color-danger-700);
